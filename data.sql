...
CREATE TABLE [dbo].[Payment](
    ...
    vnp_bank_tran_no NVARCHAR(255) NULL,
    vnp_card_type NVARCHAR(20) NULL,
    vnp_pay_date NVARCHAR(14) NULL,
    vnp_response_code NVARCHAR(2) NULL,
    amount DECIMAL(12,2) NULL,
    order_info NVARCHAR(255) NULL,
    created_at DATETIME DEFAULT GETDATE(),
    updated_at DATETIME DEFAULT GETDATE(),
    FOREIGN KEY (transactionid) REFERENCES [dbo].[Transaction](transaction_id)
    );
GO
...
BEGIN
    ...
    WHILE @i <= 50
BEGIN
INSERT INTO [dbo].[Seat] (room_id, seat_number)
VALUES (@room, CONCAT('S', FORMAT(@i,'00')));
SET @i += 1;
END
    SET @room += 1;
END
